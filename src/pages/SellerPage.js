...
function SellerPage() {
	const { loading, error, getSellerInfo } = SellerPageBL();
	return (
					...
					<div className="SellerPage">
						<div className="seller-top-box">
							<div className="seller-information">
								...
								<p className="seller-name">Hi {getSellerInfo.getSellerInfo.username}!</p>
								<p className="seller-store-name">{getSellerInfo.getSellerInfo.storename}</p>
								<p className="seller-address">{getSellerInfo.getSellerInfo.address}</p>
